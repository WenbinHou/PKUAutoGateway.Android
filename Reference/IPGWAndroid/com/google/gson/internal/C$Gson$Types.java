    ...
    public static Type resolve(Type type, Class<?> cls, Type type2) {
        ...
        if ((type3 instanceof Class) && ((Class) type3).isArray()) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                Type resolve3 = C$Gson$Types.resolve(type, cls, typeArr[i2]);
            ...
            return i != 0 ? C$Gson$Types.newParameterizedTypeWithOwner(resolve2, parameterizedType.getRawType(), typeArr) : parameterizedType;
