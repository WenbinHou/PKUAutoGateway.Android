...
public final class i implements HttpClient {
    ...
    private static String[] c = new String[]{"text/", "application/xml", "application/json"};
    private static final HttpRequestInterceptor d = new l();
    final HttpClient b;
    ...
    private i(ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.b = new m(this, clientConnectionManager, httpParams);
    }
