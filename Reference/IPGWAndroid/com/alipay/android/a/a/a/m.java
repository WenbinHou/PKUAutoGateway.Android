...
final class m extends DefaultHttpClient {
    final /* synthetic */ i a;

    m(i iVar, ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.a = iVar;
    ...
    protected final BasicHttpProcessor createHttpProcessor() {
        ...
        createHttpProcessor.addRequestInterceptor(new j(this.a));
