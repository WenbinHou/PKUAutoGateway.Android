...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        setBackgroundDrawable(VERSION.SDK_INT >= 21 ? new d(this) : new c(this));
    ...
    public void setTabContainer(ev evVar) {
        if (this.g != null) {
            removeView(this.g);
        }
        this.g = evVar;
        if (evVar != null) {
            addView(evVar);
            ViewGroup.LayoutParams layoutParams = evVar.getLayoutParams();
            layoutParams.width = -1;
            layoutParams.height = -2;
            evVar.setAllowCollapse(false);
        }
    }
